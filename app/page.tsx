    ...
    <main>
      <section className="hero">
        <div className="container hero-inner">
          ...
          <p>
            Biz100 Radar는 공시, 실적, 공식자료를 기반으로 기업이 어떤 일을 하는지와
            최근 확인해야 할 정보를 정리합니다. 투자 추천이 아닌 기업정보 제공 서비스입니다.
          </p>
      ...
      <section className="container section">
        <div className="feature-grid">
          <div className="card feature-card">
            <span>01</span>
            <h2>공식자료 중심</h2>
            <p>DART 공시, 회사 공식 홈페이지, IR 자료 링크를 중심으로 정보를 정리합니다.</p>
          </div>
          <div className="card feature-card">
            <span>02</span>
            <h2>투자 의견 제외</h2>
          ...
          <div className="card feature-card">
            <span>03</span>
            <h2>기업별 페이지</h2>
            <p>기업의 주요 사업, 공식자료 링크, 최근 확인 포인트를 한 페이지에 정리합니다.</p>
          </div>
        </div>
      </section>
      ...
      <section className="container section">
        ...
        <div className="company-grid">
          {featuredCompanies.map((company) => (
            <Link key={company.slug} href={`/kr/company/${company.slug}`} className="card company-card">
              <div className="company-row">
                <div className="initial">{company.initials}</div>
                <div>
                  <h3>{company.name}</h3>
                  <div className="meta">
                    {company.market} · 종목코드 {company.ticker} · {company.industry}
                  </div>
