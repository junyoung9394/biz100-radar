...
export const metadata: Metadata = {
  title: "재계순위",
  description:
    "2025년 공정거래위원회 공시대상기업집단 기준 국내 주요 기업집단 92개의 재계순위, 동일인, 계열회사 수, 공정자산총액을 정리합니다."
};
    ...
    <main className="container">
      <section className="page-title">
        ...
        <p>
          ...
          92개의 순위, 동일인, 계열회사 수, 공정자산총액을 정리합니다. 이 순위는
          개별 회사 순위가 아니라 기업집단 기준의 자산총액 순위입니다.
        </p>
      </section>
      ...
      <section className="card ranking-guide">
        ...
        <div className="ranking-guide-grid">
          ...
          <div>
            <strong>표시 항목</strong>
            <span>순위, 전년 순위, 동일인, 계열회사 수, 공정자산총액</span>
          </div>
        </div>
      ...
      <section className="ranking-list">
        {businessGroups.map((group) => (
          <article key={`${group.rank}-${group.groupName}`} className="card ranking-card">
            ...
            <div className="ranking-content">
              ...
              <div className="ranking-stats">
                ...
                <div>
                  <span>계열회사 수</span>
                  <strong>{group.affiliateCount.toLocaleString("ko-KR")}개</strong>
                </div>
                ...
                <div>
                  <span>전년 순위</span>
                  <strong>{group.previousRank ? `${group.previousRank}위` : "신규"}</strong>
                </div>
              </div>
