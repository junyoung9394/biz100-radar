...
const companyRevenueScale: Record<string, string> = {
  "samsung-electronics": "연 매출 약 280조 원 규모 (2024년 기준)",
  "hyundai-motor": "연 매출 약 175조 원 규모 (2024년 기준)",
  "sk-hynix": "연 매출 약 66조 원 규모 (2024년 기준)",
  "lg-energy-solution": "연 매출 약 26조 원 규모 (2024년 기준)",
  "kia": "연 매출 약 100조 원 규모 (2024년 기준)",
  "naver": "연 매출 약 10조 원 규모 (2024년 기준)",
  "kakao": "연 매출 약 7조 원 규모 (2024년 기준)",
  "posco-holdings": "연 매출 약 77조 원 규모 (2024년 기준)",
  "hanwha-aerospace": "연 매출 약 11조 원 규모 (2024년 기준)",
  "hyundai-mobis": "연 매출 약 60조 원 규모 (2024년 기준)",
  "lg-chem": "연 매출 약 53조 원 규모 (2024년 기준)",
  "samsung-sdi": "연 매출 약 18조 원 규모 (2024년 기준)",
  "samsung-biologics": "연 매출 약 5조 원 규모 (2024년 기준)",
  "celltrion": "연 매출 약 3조 원 규모 (2024년 기준)",
  "samsung-c-and-t": "연 매출 약 42조 원 규모 (2024년 기준)",
  "hd-hyundai": "연 매출 약 60조 원 규모 (2024년 기준)",
  "hd-korea-shipbuilding": "연 매출 약 25조 원 규모 (2024년 기준)",
  "hyundai-heavy-industries": "연 매출 약 12조 원 규모 (2024년 기준)",
  "doosan-enerbility": "연 매출 약 8조 원 규모 (2024년 기준)",
  "lg-electronics": "연 매출 약 87조 원 규모 (2024년 기준)",
  "sk-telecom": "연 매출 약 18조 원 규모 (2024년 기준)",
  "kb-financial-group": "연 매출 약 60조 원 규모 (2024년 기준)",
  "shinhan-financial-group": "연 매출 약 55조 원 규모 (2024년 기준)",
  "hana-financial-group": "연 매출 약 45조 원 규모 (2024년 기준)",
  "samsung-life": "연 수입보험료 약 30조 원 규모 (2024년 기준)",
  "lg-household-healthcare": "연 매출 약 7조 원 규모 (2024년 기준)",
  "amorepacific": "연 매출 약 4조 원 규모 (2024년 기준)",
  "cj-cheiljedang": "연 매출 약 30조 원 규모 (2024년 기준)",
  "hybe": "연 매출 약 2조 원 규모 (2024년 기준)",
  "kt": "연 매출 약 26조 원 규모 (2024년 기준)"
};

const companyCheckPoints: Record<string, string[]> = {
  "samsung-electronics": [
    "HBM(고대역폭메모리) 수주 현황 및 AI 서버 반도체 공급 모멘텀",
    "메모리 반도체 업황 회복 속도와 DRAM·NAND 가격 동향",
    "파운드리 사업 수율 개선 및 주요 고객사 확보 여부"
  ],
  "hyundai-motor": [
    "전기차 판매 비중 및 주요 시장(미국·유럽·인도)별 성장률",
    "미국 IRA 세액공제 적용 현황과 조지아 공장 가동 상황",
    "수소차 상용화 로드맵 및 수소 생태계 투자 일정"
  ],
  "sk-hynix": [
    "HBM3E 공급 점유율 및 엔비디아·AMD 납품 현황",
    "NAND Flash 감산 조정과 업황 회복 타이밍",
    "AI 서버 수요 확대에 따른 고부가 제품 비중 변화"
  ],
  "lg-energy-solution": [
    "미국 IRA 보조금(AMPC) 수혜 규모 및 정책 변화 리스크",
    "원통형·파우치형 배터리 주요 고객사(Tesla·GM·현대차) 수주 동향",
    "전고체 배터리 개발 일정과 차세대 기술 로드맵"
  ],
  "kia": [
    "EV6·EV9·EV3 등 전기차 라인업 글로벌 판매 실적",
    "인도 공장 가동과 신흥시장 점유율 확대 전략",
    "PBV(목적기반차량) 사업 방향과 상용 전동화 일정"
  ],
  "naver": [
    "라인야후 지분 구조 변화 및 일본 사업 방향",
    "AI 검색(HyperCLOVA X) 전환 속도와 광고 매출 변화",
    "웹툰·커머스 글로벌 성장률과 수익성 개선 여부"
  ],
  "kakao": [
    "플랫폼·콘텐츠 부문별 수익성 개선 현황",
    "카카오페이·카카오뱅크 등 계열사 실적 및 독립성",
    "AI 서비스(카나나) 경쟁력과 카카오톡 내 AI 통합 전략"
  ],
  "posco-holdings": [
    "이차전지 소재(양극재·음극재) 사업 성장률과 수익성",
    "철강 업황 회복 시점과 중국발 공급 과잉 영향",
    "수소·친환경 인프라 투자 규모와 수익화 일정"
  ],
  "hanwha-aerospace": [
    "K9 자주포 등 방산 수출 수주 잔고와 납품 이행률",
    "한화오션·한화시스템과의 방산 수직계열화 시너지",
    "우주발사체·위성 사업 투자 현황과 수익화 시점"
  ],
  "hyundai-mobis": [
    "전동화 핵심 부품(PE모듈·배터리시스템) 수주 현황",
    "현대차·기아 의존도 축소를 위한 외부 고객사 확보 전략",
    "자율주행·ADAS 소프트웨어 역량 강화 투자 방향"
  ],
  "lg-chem": [
    "양극재 사업 수율·수익성과 LG에너지솔루션 공급 구조",
    "석유화학 부문 업황 회복과 원가 경쟁력 확보 여부",
    "생명과학(제약·백신) 파이프라인 임상 진행 현황"
  ],
  "samsung-sdi": [
    "전기차 배터리 고객사 다변화(BMW·Stellantis·현대차) 현황",
    "전고체 배터리 양산 로드맵과 기술 선도 경쟁 구도",
    "소형전지 부문 IT·전동공구 수요 회복 타이밍"
  ],
  "samsung-biologics": [
    "5·6공장 완공 일정과 생산 캐파 확대 효과",
    "글로벌 빅파마 CDMO 수주 잔고와 계약 다변화 현황",
    "삼성바이오에피스 파이프라인 허가 및 출시 일정"
  ],
  "celltrion": [
    "짐펜트라(피하주사 인플릭시맙) 미국 시장 침투율",
    "셀트리온헬스케어 합병 후 통합 시너지와 영업이익 개선",
    "차세대 바이오시밀러 파이프라인 허가·출시 일정"
  ],
  "samsung-c-and-t": [
    "건설 부문 해외 프로젝트 수주 잔고 및 원가 관리",
    "삼성전자 최대주주로서 배당 수익과 자회사 가치",
    "패션·리조트 등 소비재 부문 성장성"
  ],
  "hd-hyundai": [
    "조선 수주 잔고와 LNG선·컨테이너선 납기 이행 현황",
    "에너지(현대오일뱅크) 부문 정제마진 변화",
    "산업기계·로봇 부문 글로벌 수요와 점유율"
  ],
  "hd-korea-shipbuilding": [
    "LNG선·암모니아 추진선 수주 잔고와 선가 현황",
    "현대중공업·현대미포 조선소별 수율 및 인력 상황",
    "친환경 선박 기술 선도와 그린 얼라이언스 협력"
  ],
  "hyundai-heavy-industries": [
    "선박 건조 수주 잔고와 LNG·컨테이너선 납기 현황",
    "조선소 가동률 상승에 따른 매출 인식 속도",
    "해양플랜트 사업 재개 여부와 수익성"
  ],
  "doosan-enerbility": [
    "국내외 원전 수주 현황과 체코·폴란드 수출 협상 경과",
    "가스터빈 국산화 완료 후 수주 파이프라인 확보",
    "SMR(소형모듈원전) 사업 개발 현황과 상용화 일정"
  ],
  "lg-electronics": [
    "B2B(전장·HVAC·빌트인) 사업 비중 확대와 수익성 개선",
    "올레드 TV 프리미엄 전략과 글로벌 점유율 유지",
    "구독형 가전 서비스 성장률과 수익 구조 변화"
  ],
  "sk-telecom": [
    "AI 서비스(에이닷·통화 AI) 가입자 성장과 수익화 속도",
    "데이터센터·클라우드 인프라 투자 규모와 수요 전망",
    "이동통신 ARPU(가입자당 매출) 방어와 5G 보급률"
  ],
  "kb-financial-group": [
    "이자이익·비이자이익 비중 변화와 NIM(순이자마진) 방어",
    "해외 법인(인도네시아·베트남 등) 성장성과 리스크",
    "디지털·비대면 전환 속도와 KB스타뱅킹 점유율"
  ],
  "shinhan-financial-group": [
    "NIM 하락 압력과 대출 성장률 균형 관리",
    "신한투자증권·신한라이프 계열사 이익 기여도",
    "글로벌(베트남·일본) 사업 성장과 리스크 관리"
  ],
  "hana-financial-group": [
    "대출 성장률과 건전성(NPL) 지표 관리",
    "하나증권 IB·자산관리 수익성 개선 여부",
    "외환·글로벌 사업 경쟁력과 수익 기여"
  ],
  "samsung-life": [
    "보험영업이익과 투자이익 비중 변화",
    "IFRS17 기준 보험계약마진(CSM) 규모와 상각 속도",
    "삼성전자 지분 가치와 자산 포트폴리오 변화"
  ],
  "lg-household-healthcare": [
    "중국 화장품 사업 회복 속도와 면세 채널 매출",
    "프리미엄 브랜드(후·숨·오휘) 글로벌 확장 전략",
    "음료 부문 코카콜라 판매 동향과 원가 관리"
  ],
  "amorepacific": [
    "중국 소비 회복에 따른 설화수·라네즈 매출 변화",
    "북미·유럽 화장품 시장 진출 성과와 성장률",
    "원브랜드숍 구조조정 후 오프라인 채널 재편 방향"
  ],
  "cj-cheiljedang": [
    "글로벌 식품(슈완스·K푸드) 해외 매출 성장률",
    "바이오 부문 아미노산·핵산 판가 및 업황",
    "HMR(간편식) 국내 점유율 유지와 수익성"
  ],
  "hybe": [
    "BTS 멤버 군 복무 종료 후 활동 재개와 앨범 성과",
    "어도어·빌리프랩 등 레이블 아티스트 글로벌 인기도",
    "위버스 플랫폼 MAU와 팬덤 커머스 수익화 속도"
  ],
  "kt": [
    "AI 사업(AI 콘택센터·AI 인프라) 수익화 속도",
    "기업통신·클라우드 B2B 사업 성장률",
    "미디어(KT스튜디오지니·시즌) 콘텐츠 투자 효율성"
  ]
};
...
const companyDartCorpCodes: Record<string, string> = {
  ...
  "db-financial-investment": "00107673",
  "db-hi-tek": "00160843",
  ...
  "doosan-bobcat": "01385280",
  "doosan-enerbility": "00159616",
  "doosan-fuel-cell": "01551739",
...
identifiers: {
  ...
  dartCorpCode: companyDartCorpCodes[slug]
    ...
    checkPoints: companyCheckPoints[slug],
    revenueScale: companyRevenueScale[slug],
    sourceNote:
